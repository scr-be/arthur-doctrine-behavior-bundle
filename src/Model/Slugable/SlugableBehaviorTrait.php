...
/**
 * Class SlugableBehaviorTrait.
 */
trait SlugableBehaviorTrait
{
    /**
     * @var string
     */
    ...
    public function setSlug($slug)
    {
        ...
        throw BehaviorOrmException::create()
            ->setMessage('Cannot set slug for entity "%s" as it is configured to be auto-generated.')
    ...
    public function triggerGenerateSlugEvent()
    {
        if (false !== $this->isSlugAutoGenerated() || null === $this->slug) {
            ...
            if (false === (count($usablePropertyNames) > 0)) {
                throw BehaviorOrmException::create()
                    ->setMessage('At lease one of the following fields must be non-null and not-empty to generate slug: %s.')
                    ->with(implode(',', (array) $this->getAutoSlugFields()));
            }
